...
export default async function AppHeader({ hideAuthIndicator = false }: { hideAuthIndicator?: boolean }) {
    ...
    <header className="topBar appHeader">
      <div className="wrap topBarInner">
        ...
        <div className="appHeaderRight">
          {hideAuthIndicator ? null : <AuthIndicator email={emailOrPhone} userId={userId} />}
        </div>
      </div>
    </header>
  );
