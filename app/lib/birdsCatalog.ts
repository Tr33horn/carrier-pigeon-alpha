...
/**
 * ✅ Seal behavior per bird
 * - selectable: user can pick from allowedSealIds (defaults to defaultSealId)
 * - fixed: forced seal, user cannot change
 * - none: no seal concept for this bird (rare)
 */
export type SealPolicy = "selectable" | "fixed" | "none";
...
export type BirdCatalogRow = {
  ...
  /** For sealPolicy="selectable" */
  defaultSealId?: string | null;
  allowedSealIds?: string[];

  /** For sealPolicy="fixed" */
  fixedSealId?: string | null;
};
...
/**
 * ✅ Default seal set you can offer for selectable birds.
 * You will create these as images later in /public/seals/...
 * (These are just IDs for now.)
 */
const DEFAULT_SELECTABLE_SEALS = ["seal_classic", "seal_midnight", "seal_ivy", "seal_sun"] as const;
...
export const BIRD_CATALOG: BirdCatalogRow[] = [
...

  {
    ...
    sealPolicy: "selectable",
    defaultSealId: "seal_classic",
    allowedSealIds: ["seal_classic","seal_flokheart", "seal_floksun", "seal_flokflame"],
  },
...

  {
    ...
    // ✅ Seals (fixed feels right here too)
    sealPolicy: "fixed",
    fixedSealId: "seal_midnight",
  },

  {
    ...
    // ✅ Seals (unchangeable raven seal)
    sealPolicy: "fixed",
    fixedSealId: "seal_raven",
  },
...

  {
    ...
    // ✅ Seals (fixed crow seal)
    sealPolicy: "fixed",
    fixedSealId: "seal_crow",
  },
