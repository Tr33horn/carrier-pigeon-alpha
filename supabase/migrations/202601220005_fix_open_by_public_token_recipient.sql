...
begin
  ...
  update public.letters
    set recipient_user_id = coalesce(public.letters.recipient_user_id, auth.uid()),
        opened_at = coalesce(public.letters.opened_at, now())
    where public.letters.id = v_letter.id;
